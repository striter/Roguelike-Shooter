...
public class ActionTester : MonoBehaviour {
    ...
    UIT_GridControllerGridItem<UIT_GridDefaultItem> m_GridOwned;
    ...
    private void Awake()
    {
        ...
        m_GridOwned = new UIT_GridControllerGridItem<UIT_GridDefaultItem>(m_OwnedParent.transform.Find("Viewport/ActionOwned"));
