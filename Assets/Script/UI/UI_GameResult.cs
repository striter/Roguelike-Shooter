...
public class UI_GameResult : UIPage {
    ...
    {
        m_level = level;
        m_ResultTitle.sprite = GameUIManager.Instance.m_InGameSprites[UIConvertions.GetUIGameResultTitleBG(level.m_GameWin,OptionsDataManager.m_OptionsData.m_Region)];
