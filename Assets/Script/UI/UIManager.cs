...
public class UIManager : SingletonMono<UIManager> {
    ...
    Text txt_Ammo,txt_Mana,txt_Health,txt_Armor,txt_Coin;
    ...
    private void Start()
    {
        TBroadCaster<enum_BC_UIStatusChanged>.Add<EntityPlayerBase>(enum_BC_UIStatusChanged.PlayerInfoChanged, OnAmmoChanged);
    }
    private void OnDisable()
    {
        TBroadCaster<enum_BC_UIStatusChanged>.Remove<EntityPlayerBase>(enum_BC_UIStatusChanged.PlayerInfoChanged, OnAmmoChanged);
    }
    void OnAmmoChanged(EntityPlayerBase player)
    {
