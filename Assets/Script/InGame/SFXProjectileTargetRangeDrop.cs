...
public class SFXProjectileTargetRangeDrop : SFXProjectile {
    ...
    protected override PhysicsSimulator GetSimulator(Vector3 direction, Vector3 targetPosition) => new ProjectilePhysicsLerpSimulator(transform, transform.position, targetPosition+Vector3.up*F_DropStartHeight, OnAnimFinished, F_Speed, F_Height, F_Radius, GameLayer.Physics.I_All, OnPhysicsCasted);
    ...
    protected override void Update()
    {
        ...
        ObjectManager.SpawnSFX<SFXProjectile>(I_ProjectileDrop, startPos, Vector3.down).Play(I_SourceID,Vector3.down,startPos+Vector3.down*F_DropStartHeight,m_DamageInfo.m_BuffApply);
