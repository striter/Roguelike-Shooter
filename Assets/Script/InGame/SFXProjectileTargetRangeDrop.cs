...
public class SFXProjectileTargetRangeDrop : SFXProjectile {
    ...
    protected override void Update()
    {
        ...
        ObjectManager.SpawnEquipment<SFXProjectile>(GameExpression.GetEquipmentSubIndex(I_SFXIndex), startPos, Vector3.down).Play(m_DamageInfo.m_detail, Vector3.down,startPos+Vector3.down*F_DropStartHeight);
