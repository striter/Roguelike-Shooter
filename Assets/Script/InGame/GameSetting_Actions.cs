...
namespace GameSetting_Action
{
    ...
    public static class ActionData
    {
        ...
        public static float F_30003_ExplosiveDamage(enum_RarityLevel rarity) => 25 + 25 * (int)rarity;
    ...
    public class Action_10025_ArmorAdditiveMultiply : ActionAfterUse
    {
        ...
        {
            base.OnActionUse();
            ActionHelper.ReceiveHealing(m_ActionEntity, Value1/100f * m_ActionEntity.m_PlayerHealth.m_CurrentArmor, enum_DamageType.ArmorOnly);
        }
    ...
    public class Action_10026_DamageAdditiveArmorMultiply : ActionBase
    {
        ...
        public override float m_DamageAdditive=> Value1 * m_ActionEntity.m_PlayerHealth.m_CurrentArmor; 
    ...
    public class Action_10028_ArmorSingleShot : ActionSingleBurstShotKill
    {
        ...
        public override float m_DamageAdditive => m_BurstShot ? Value1 * m_ActionEntity.m_PlayerHealth.m_CurrentArmor / 100f:0;
    ...
    public class Action_10035_ImmediateReloadShotsBurst : ActionSingleBurstShotKill
    {
        ...
        {
            base.OnActionUse();
            m_ActionEntity.m_WeaponCurrent.TryReload();
        }
    ...
    public class Action_20001_RustShot : ActionAfterUse
    {
        ...
        {
            base.OnActionUse();
            m_ActionEntity.AcquireEquipment(m_Index, () =>  DamageDeliverInfo.BuffInfo(m_ActionEntity.I_EntityID,SBuff.CreateActionDamageBuff(m_Index,Value1,1f,Value2, enum_DamageType.Common)));
        }
