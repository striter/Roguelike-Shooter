...
public class SFXProjectileTargetRangeDrop : SFXProjectile {
    ...
    protected override PhysicsSimulator<HitCheckBase> GetSimulator(Vector3 direction, Vector3 targetPosition) => new LerpPSimulator<HitCheckBase>(transform, transform.position, targetPosition+Vector3.up*F_DropStartHeight, OnStop, Vector3.Distance(transform.position, targetPosition) / F_Speed, F_Height, F_Radius, GameLayer.Mask.I_ProjectileMask, OnHitTargetBreak,CanHitTarget);
