            ...
            switch (level)
            {
                ...
                case enum_StageLevel.Veteran:
                    return StageInteractGenerateData.Create(
                        ...
                        new Dictionary<enum_ActionRarity, float> { { enum_ActionRarity.Normal, 0 }, { enum_ActionRarity.OutStanding, 0 }, { enum_ActionRarity.Epic, 0 } },
                        new Dictionary<enum_ActionRarity, float> { { enum_ActionRarity.Normal, 5.6f }, { enum_ActionRarity.OutStanding, 0 }, { enum_ActionRarity.Epic, 0 } },
                        new Dictionary<enum_WeaponRarity, float> {{ enum_WeaponRarity.Advanced, 2.8f },{ enum_WeaponRarity.Rare,1.4f} }),
                ...
                case enum_StageLevel.Ranger:
                    return StageInteractGenerateData.Create(
                        ...
                        PickupGenerateData.Create(10, 10, 30, new RangeInt(2, 3),
                        new Dictionary<enum_ActionRarity, float> { { enum_ActionRarity.Normal, 0 }, { enum_ActionRarity.OutStanding, 0 }, { enum_ActionRarity.Epic, 0 } },
                        new Dictionary<enum_ActionRarity, float> { { enum_ActionRarity.Normal, 5 }, { enum_ActionRarity.OutStanding, 0 }, { enum_ActionRarity.Epic, 0 } },
