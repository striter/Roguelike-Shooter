...
namespace GameSetting
{
    ...
    {
        #region Battle
        public static readonly RangeInt RI_EnermyGenerateDuration = new RangeInt(10, 20);
        public const float F_EnermyGenerateTickMultiplierPerMinute =.08f;
        public const float F_EnermyGenerateTickMultiplierTransmiting = 2f;

        public const float F_EnermyEliteGenerateBase = 15f;
        public const float F_EnermyEliteGeneratePerMinuteMultiplier = 5f;
