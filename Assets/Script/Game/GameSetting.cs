            ...
            switch (level)
            {
                ...
                case enum_StageLevel.Veteran:
                    return StageInteractGenerateData.Create(
                        ...
                        new Dictionary<enum_ActionRarity, float> { { enum_ActionRarity.Normal, 0 }, { enum_ActionRarity.OutStanding, 0 }, { enum_ActionRarity.Epic, 0 } },
                        new Dictionary<enum_ActionRarity, float> { { enum_ActionRarity.Normal, 6.8f }, { enum_ActionRarity.OutStanding, 0 }, { enum_ActionRarity.Epic, 0 } },
                        new Dictionary<enum_WeaponRarity, float> {{ enum_WeaponRarity.Advanced, 3.4f },{ enum_WeaponRarity.Rare,1.7f} }),
