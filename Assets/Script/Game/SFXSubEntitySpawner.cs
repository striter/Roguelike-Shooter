...
public class SFXSubEntitySpawner : SFXWeaponBase {
    ...
    {
        base.OnPlay();
        EntityCharacterBase entity = GameObjectManager.SpawnEntityCharacter(I_EntitySpawnID, NavigationManager.NavMeshPosition(transform.position), m_targetPos, m_Spawner.m_Flag, m_Spawner.m_EntityID, m_StartHealth);
