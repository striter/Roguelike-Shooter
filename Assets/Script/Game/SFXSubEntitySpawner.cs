...
public class SFXSubEntitySpawner : SFXWeaponBase {
    ...
    {
        base.OnPlay();
        EntityCharacterAI entity = GameObjectManager.SpawnEntityCharactterAI(I_EntitySpawnID, NavigationManager.NavMeshPosition(transform.position), m_targetPos, m_Spawner.m_Flag,GameManager.Instance.m_GameLevel.m_GameDifficulty,GameManager.Instance.m_GameLevel.m_GameStage,true, m_Spawner.m_EntityID, m_StartHealth);
