...
public class EntityCharacterPlayerRailer : EntityCharacterPlayer {
    ...
    DamageInfo GetAbilityDamageInfo() => new DamageInfo(m_EntityID, F_AbilityDamageBase + F_AbilityDamageExtraMultiply * m_CharacterInfo.F_DamageAdditive + m_CharacterInfo.m_RankManager.m_Rank * F_AbilityDamageRankMultiply, 0f, m_CharacterInfo.m_CriticalHitRate * F_AbilityCriticalRateMultiply, 0f, enum_DamageType.Basic, -1);
