...
public class InteractWeaponReforge : InteractGameBase
{
    ...
    protected override bool OnInteractedContinousCheck(EntityCharacterPlayer _interactor)
    {
        ...
        _interactor.GameWeaponReforge(GameObjectManager.SpawnWeapon(WeaponSaveData.CreateNew(GameDataManager.m_GameWeaponUnlocked[TCommon.RandomPercentage(GameConst.D_EventWeaponReforgeRate, null)].RandomItem())));
        m_ReforgeTime++;
        if (m_ReforgeTime == 1)
