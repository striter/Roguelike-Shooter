...
public class EEntity : Editor {
    ...
    {
        m_EnermyBase = target as EntityCharacterAI;
        ...
        if (HasPreviewGUI())
        {
            ...
            DestroyImmediate(m_PreviewObject.GetComponent<EntityCharacterAI>());
